...
namespace DataToExcel
{
    ...
    public class DieData
    {
        ...
        public override bool Equals(object o)
        {
            ...
            if ((((this._attribute != data._attribute) || (this._bin != data._bin)) || (this._x != data._x)) || (this._y != data._y) || (this._site != data._site))
            {
                return false;
            }
            return true;
        ...
        public override string ToString()
        {
            ...
            text += "X = " + this._x.ToString() + ", ";
            text += "Y = " + this._y.ToString() + ", ";
            text += "Site = " + this._site.ToString() + ", ";
            text += "Bin = " + this._bin.ToString() + ", ";
            text += "Attribute = " + this._attribute.ToString();
