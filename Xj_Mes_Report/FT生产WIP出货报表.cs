...
{
    public partial class FT生产WIP出货报表 : DockContent
    {
        public FT生产WIP出货报表()
        {
            InitializeComponent();
        ...
        private void buttonX1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string test_type = this.textBoxX1.Text.ToString();
                ...
                string sql = string.Format("[dbo].[FT_WIP_20220608] '{0}','{1}','{2}','{3}','{4}','{5}'", cus_name, lot, test_type, is_date, dat1, dat2);
        ...
        private void buttonX3_Click(object sender, EventArgs e)
        {
            ...
            pwt_system_comm_out.NPIOExcelHelper.ImportDataTableToExecl(dtb_xls, "WIP报告" + DateTime.Now.ToString("yyyyMMdd") + ".xlsx");
            MessageBox.Show("导出成功", "系统提示");
        }

        private void CP生产出货报表_Load(object sender, EventArgs e)
        {
