...
namespace Xj_Mes_cp
{
    public partial class LOT下线信息管理 : DockContent
    {
        public LOT下线信息管理()
        {
            InitializeComponent();
        ...
        private void buttonX1_Click(object sender, EventArgs e)
        {
            ...
            string sql_str = string.Format("[dbo].[hp_1022_cp_down_line_info_deal_select] '{0}','{1}','{2}','{3}','{4}','{5}','{6}'", cus_name, lot, mate_name, mate_ves, check_date, dat1, dat2);
