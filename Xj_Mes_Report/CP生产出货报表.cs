...
{
    public partial class CP生产出货报表 : DockContent
    {
        public CP生产出货报表()
        {
            InitializeComponent();
        ...
        private void buttonX1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string sql = string.Format("[dbo].[hp_20220329_total_tsk_info_only_one_select] '{0}','{1}','{2}','{3}','{4}','{5}'", cus_name, test_type, is_date, dat1, dat2, lot);
        ...
        private void buttonX3_Click(object sender, EventArgs e)
        {
            ...
            pwt_system_comm_out.NPIOExcelHelper.ImportDataTableToExecl(dtb_xls, "CP生产出货报告" + DateTime.Now.ToString("yyyyMMdd") + ".xlsx");
