...
namespace DataToExcel
{
    ...
    public class MTma : MappingBase
    {
        ...
        public MTma(string file)
            : base(ConstDefine.FileType_MTMA, file)
        {
            this._refDiePoint = -1;
        }
        ...
        public override void Save()
        {
            try
            {
              ...
              //  this.WriteString("LOT ID          :" + newlotid[0] + "\r\n");
                // this.WriteString("WAFER ID        :" + this.WaferID + "\r\n");

              //  this.WriteString("WAFER ID        :" + newwaferid[newwaferid.Length-1] + "\r\n");
                this.WriteString("LOT ID          :" + this.LotNo + "\r\n");
                this.WriteString("WAFER ID        :" + Convert.ToInt32(this.SlotNo).ToString("00") + "\r\n");
                this.WriteString("FLOW ID         :" + "CP1" + "\r\n");
                this.WriteString("START TIME      :" + this.LoadTime + "\r\n");
                this.WriteString("STOP TIME       :" + this.UnloadTime + "\r\n");
                this.WriteString("SUBCON          :" + "HTCP" + "\r\n");
                ...
                this.WriteString("MAP ROW         :" + (ymax - ymin + 1) + "\r\n");
                //  this.WriteString("MAP COLUMN      :" + this.DieMatrix.XMax+"\r\n");
                this.WriteString("MAP COLUMN      :" + (xmax - xmin + 1) + "\r\n");
                this.WriteString("MAP BIN LENGTH  :" + "2" + "\r\n");
                ...
                for (int y = ymin; y < ymax + 1; y++)
                {
                    ...
                    this.WriteString((y - ymin + 1).ToString("000") + " ");
                            ...
                            case DieCategory.PassDie:
                                {
                                    ...
                                    this.WriteString(string.Format("{0,3}", this.DieMatrix[x, y].Bin));
                                    break;
                                }
                            ...
                            case DieCategory.SkipDie2:
                                {
                                    ...
                                    this.WriteString(string.Format("{0,3}", "   "));
                                    break;
                                }
