...
namespace DataToExcel
{
    ...
    public class HHGTma : MappingBase
    {
        ...
        public HHGTma(string file)
            : base(ConstDefine.FileType_HHGTMA, file)
        {
            this._refDiePoint = -1;
        }
        ...
        public override void Save()
        {
            try
            {
                ...
                this.WriteString("WAFER ID        :" + newwaferid[2] + "\r\n");
