...
namespace Xj_Mes_cp
{
    public partial class Lot质量IQC过站管理 : DockContent
    {
        public Lot质量IQC过站管理()
        {
            InitializeComponent();
        ...
        private void buttonX1_Click(object sender, EventArgs e)
        {
            ...
            DataTable dt_oqc = ex.Get_Data("[dbo].[hp_1116_qc_info_deal_check] '" + LOT_ONLY_CODE + "','IQC检验'");
        ...
        private void buttonX2_Click(object sender, EventArgs e)
        {
            ...
            DataTable dt_oqc = ex.Get_Data("[dbo].[hp_1116_qc_info_deal_check] '" + only_code + "','IQC检验'");
            ...
            DataTable dt = ex.Get_Data("[dbo].[hp_1116_qc_info_insert01]  'IQC检验','" + only_code + "','" + qc_res + "','" + deal_res + "','" + do_user + "','" + post_info + "','" + post_number + "'");
