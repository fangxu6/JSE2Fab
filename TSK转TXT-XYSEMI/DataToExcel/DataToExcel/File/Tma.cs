    ...
    public class Tma : MappingBase
    {
        ...
        public override void Save()
        {
            try
            {
                ...
                this.WriteString("LOT ID          : " + this.LotNo + "\r\n");
                // this.WriteString("WAFER ID        :" + this.WaferID + "\r\n");
                this.WriteString("WAFER ID        : " + newwaferid[1] + "\r\n");
                this.WriteString("FLOW ID         : " + "CP3" + "\r\n");
                this.WriteString("START TIME      : " + this.LoadTime.ToString("yyyy/MM/dd HH:mm:ss") + "\r\n");
                this.WriteString("STOP TIME       : " + this.UnloadTime.ToString("yyyy/MM/dd HH:mm:ss") + "\r\n");
                ...
                this.WriteString("   BIN,        2," + BIN2.ToString().PadLeft(15, ' ') + "," + Math.Round(((double)BIN2 / (double)(this.TotalDie)), 4).ToString("0.00%").PadLeft(9, ' ') + "," + "  {[GOODBIN]}" + "\r\n");
                this.WriteString("   BIN,        3," + BIN3.ToString().PadLeft(15, ' ') + "," + Math.Round(((double)BIN3 / (double)(this.TotalDie)), 4).ToString("0.00%").PadLeft(9, ' ') + "," + "  {[GOODBIN]}" + "\r\n");
                ...
                this.WriteString("   BIN,       23," + BIN23.ToString().PadLeft(15, ' ') + "," + Math.Round(((double)BIN23 / (double)(this.TotalDie)), 4).ToString("0.00%").PadLeft(9, ' ') + "," + "  {[GOODBIN]}" + "\r\n");
                this.WriteString("   BIN,       24," + BIN24.ToString().PadLeft(15, ' ') + "," + Math.Round(((double)BIN24 / (double)(this.TotalDie)), 4).ToString("0.00%").PadLeft(9, ' ') + "," + "  {[GOODBIN]}" + "\r\n");
                ...
                {
                    this.WriteString("\r\n");
                    this.WriteString((y + 1).ToString("000"));
