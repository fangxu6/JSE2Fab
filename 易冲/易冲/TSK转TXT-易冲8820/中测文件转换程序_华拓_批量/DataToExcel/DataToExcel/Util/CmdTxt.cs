        ...
        public override void Save()
        {
            try
            {
                try
                {
                    ...
                    base.OpenWriter();
                    this.WriteString("    ");
                   // for (int i = 0; i < base.DieMatrix.XMax-2; i++)
                   ...
                   // for (int j = 0; j < base.DieMatrix.XMax-2; j++)
                  ...
                  //  for (int k = 0; k < base.DieMatrix.YMax; k++)
                    ...
                    {
                        this.WriteString(base.Enter + ((k -ymin+1)).ToString("000") + "|");
                       
                      //  for (int m = 0; m < base.DieMatrix.XMax-2; m++)
