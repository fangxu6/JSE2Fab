...
{
    public class Device_C8A000WAB_8_30_P01 : ExpToExcelSoftBin
    {
        public override void expToExcel(Worksheet worksheet)
        {
            ...
            Excel.Range rngbin12 = (Excel.Range)worksheet.Cells[7, 14];
            rngbin12.Value2 = "Bin12:FUNC_mbist_2V_FAIL";

            Excel.Range rngbin13 = (Excel.Range)worksheet.Cells[7, 12];
            rngbin13.Value2 = "Bin13:FUNC_mbist_1P4V_FAIL";

            Excel.Range rngbin14 = (Excel.Range)worksheet.Cells[7, 13];
            rngbin14.Value2 = "Bin14:SDO_5V_FAIL";

            Excel.Range rngbin15 = (Excel.Range)worksheet.Cells[7, 14];
            rngbin15.Value2 = "Bin15:IOUT_27K_FAIL";

            Excel.Range rngbin16 = (Excel.Range)worksheet.Cells[7, 12];
            rngbin16.Value2 = "Bin16:SKEW_27K_FAIL";

            Excel.Range rngbin17 = (Excel.Range)worksheet.Cells[7, 13];
            rngbin17.Value2 = "Bin17:IOUT_27K_AVE_FAIL";

            Excel.Range rngbin18 = (Excel.Range)worksheet.Cells[7, 14];
