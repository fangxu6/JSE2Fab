        ...
        public override void Save()
        {
            try
            {
                try
                {
                    ...
                    this.WriteString("Wafer Size: " + WaferSize1 + "\r\n");
                    ...
                    this.WriteString("Wafer Test Start Time:" + this.LoadTime + "\r\n");
                    this.WriteString("Wafer Test Finish Time:" + this.EndTime + "\r\n");
                    this.WriteString("Total test die:" + (this.PassDie + this.FailDie) + "\r\n");
                    this.WriteString("Pass Die:" + this.PassDie + "\r\n");
                    this.WriteString("Fail Die:" + this.FailDie + "\r\n");
                    this.WriteString("Yield:" + Math.Round(Convert.ToDouble((double)(this.PassDie / ((double)(this.PassDie + this.FailDie)))), 4).ToString("0.0000%") + "\r\n");
