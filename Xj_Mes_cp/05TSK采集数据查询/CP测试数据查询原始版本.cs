...
namespace Xj_Mes_cp
{
    public partial class CP测试数据查询原始版本 : DockContent
    {
        public CP测试数据查询原始版本()
        {
            InitializeComponent();
        ...
        private void buttonX1_Click(object sender, EventArgs e)
        {
            ...
            string sql_str = string.Format("[dbo].[hp_1009_tsk_info_select_old]  '{0}','{1}','{2}','{3}','{4}','{5}','{6}','{7}'", lot, eq, is_check, dat1, dat2, info1, info2, info3);
